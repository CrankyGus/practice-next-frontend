        ...
        <header>
          <div className="flex fixed justify-between items-center px-14 md:px-24 py-8 top-0 w-full bg-[rgba(0,0,0,0.6)] backdrop-blur-md  text-white z-50">
            ...
            <div className="space-x-2 hidden md:flex">
              {/*<a className="p-4 transition-all rounded-2xl hover:bg-red-400 ">
              </a>*/}
              <Link href="/Login">
                <a className="p-4 transition-all rounded-2xl hover:bg-red-400">
                  Login
              ...
              <Link href="/">
                <a className="p-4 transition-all rounded-xl bg-red-500 hover:bg-blue-500">
                  Contacts
                </a>
              </Link>
            </div>
            ...
            {isMenu ? (
              <FaWindowClose
                className="md:hidden text-xl cursor-pointer transition-all hover:scale-125"
                onClick={() => {
                  setIsMenu(!isMenu);
                }}
              />
              ...
              >
                <FaTh className="md:hidden cursor-pointer transition-all hover:scale-125" />
              </button>
            )}
            {isMenu ? (
        ...
        <header>
          <div className="flex fixed justify-between items-center px-14 md:px-24 py-8 top-0 w-full  text-white z-50">
            ...
            {isMenu ? (
              ...
              <FaTh
                className="md:hidden cursor-pointer transition-all hover:scale-125"
                onClick={() => {
                  setIsMenu(!isMenu);
                }}
              />
